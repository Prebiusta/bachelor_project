...
class SigningProcessControllerApi {
  ...
  const SigningProcessControllerApi(this._dio, this._serializers);
  ...
  Future<Response<BaseResponse>> approveDocument({ 
    ...
    final _path = r'/api/signingProcess/approveDocument';
    ...
    try {
      const _type = FullType(ApproveDocumentRequest);
  ...
  Future<Response<BuiltList<User0>>> getActiveApprovers({ 
    ...
    final _path = r'/api/signingProcess/getActiveApprovers';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [processIdRequest] - processIdRequest
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<DocumentWithContent>> getDocumentDetails1({ 
    ...
    final _path = r'/api/signingProcess/getDocumentDetails';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(processIdRequest, specifiedType: _type);
    ...
    DocumentWithContent _responseData;

    try {
      const _responseType = FullType(DocumentWithContent);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<DocumentWithContent>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<BuiltList<DocumentWithProcessResponse>>> getDocumentsForApproval({ 
    ...
    final _path = r'/api/signingProcess/getDocumentsForApproval';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<BuiltList<DocumentWithProcessResponse>>> getDocumentsForInspection({ 
    ...
    final _path = r'/api/signingProcess/getDocumentsForInspection';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [SignfluentSignatureRequest] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<SignfluentSignatureRequest>> getSignatureRequest({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/signingProcess/getSignatureRequest';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    SignfluentSignatureRequest _responseData;

    try {
      const _responseType = FullType(SignfluentSignatureRequest);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as SignfluentSignatureRequest;
    ...
    return Response<SignfluentSignatureRequest>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [inspectDocumentRequest] - inspectDocumentRequest
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<BaseResponse>> inspectDocument({ 
    ...
    final _path = r'/api/signingProcess/inspectDocument';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(InspectDocumentRequest);
      _bodyData = _serializers.serialize(inspectDocumentRequest, specifiedType: _type);
  ...
  ///
  /// Parameters:
  /// * [signfluentSignature] - signfluentSignature
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<BaseResponse>> submitSignature({ 
    ...
    final _path = r'/api/signingProcess/submitSignature';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SignfluentSignature);
      _bodyData = _serializers.serialize(signfluentSignature, specifiedType: _type);
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> uploadDocument({ 
    required UploadDocumentRequest uploadDocumentRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/signingProcess/uploadDocument';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UploadDocumentRequest);
      _bodyData = _serializers.serialize(uploadDocumentRequest, specifiedType: _type);
