...
class UserControllerApi {
  ...
  Future<Response<UserCreateResponse>> createUser({ 
    ...
    final _path = r'/api/user/createUser';
  ...
  Future<Response<BuiltList<User>>> getAllUsers({ 
    ...
    final _path = r'/api/user/getAllUsers';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<User>> getCurrentUserDetails({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/user/getCurrentUserDetails';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<User>> getUserDetails({ 
    ...
    final _path = r'/api/user/getUserDetails/{userId}'.replaceAll('{' r'userId' '}', userId.toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
