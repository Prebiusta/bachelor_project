...
class DeviceControllerApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [RegisterDeviceResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<RegisterDeviceResponse>> register({ 
    ...
    final _path = r'/api/device/register';
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UpdateFCMTokenResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UpdateFCMTokenResponse>> updateFCMToken({ 
    required UpdateFCMTokenRequest updateFCMTokenRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/device/updateFCMToken';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UpdateFCMTokenRequest);
      _bodyData = _serializers.serialize(updateFCMTokenRequest, specifiedType: _type);
    ...
    UpdateFCMTokenResponse _responseData;

    try {
      const _responseType = FullType(UpdateFCMTokenResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
    ...
    return Response<UpdateFCMTokenResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
