...
class _$UploadDocumentRequest extends UploadDocumentRequest {
  ...
  _$UploadDocumentRequest._({this.description, this.document, this.userId})
      : super._();
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc(0, description.hashCode), document.hashCode), userId.hashCode));
  }
  ...
  _$UploadDocumentRequest build() {
    final _$result = _$v ??
        new _$UploadDocumentRequest._(
            description: description, document: document, userId: userId);
    replace(_$result);
    return _$result;
  }
}
