...
class _$AssignApproversRequest extends AssignApproversRequest {
  ...
  _$AssignApproversRequest._({this.approvers, this.processId}) : super._();
  ...
  @override
  int get hashCode {
    return $jf($jc($jc(0, approvers.hashCode), processId.hashCode));
  }
    ...
    try {
      _$result = _$v ??
          new _$AssignApproversRequest._(
              approvers: _approvers?.build(), processId: processId);
    } catch (_) {
