...
class AuthenticationControllerApi {
  ...
  const AuthenticationControllerApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [UserCreateResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<UserCreateResponse>> createUser({ 
    ...
    final _path = r'/api/auth/createUser';
    ...
    UserCreateResponse _responseData;

    try {
      const _responseType = FullType(UserCreateResponse);
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AuthenticationResponse>> login({ 
  ...
  /// Returns a [Future] containing a [Response] with a [AuthenticationResponse] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<AuthenticationResponse>> refreshAuthToken({ 
    ...
    final _path = r'/api/auth/refreshToken';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
